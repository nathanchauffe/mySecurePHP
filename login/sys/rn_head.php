    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <form class="navbar-form navbar-right" action="/login/sys/newlogin.php" method="POST">
            <div class="form-group">
              <input name="username" type="text" placeholder="<?php echo "$username"; ?>" value="<?php echo "$username"; ?>" class="form-control">
            </div>
            <div class="form-group">
